...
# 1. CARREGAMENTO DE BIBLIOTECAS (COM INSTALAÇÃO AUTOMÁTICA)
if (!require("pacman")) install.packages("pacman")
pacman::p_load(sf, readxl, dplyr, ggplot2, tmap, stringr, spdep)
...
# Definimos a vizinhança pelo critério "Rook", contiguidade com bordas comuns. A matriz de pesos é padronizada (estilo W).
...
Todo o trabalho encontra-se no Github: https://github.com/fgvcode/estatisespacial
