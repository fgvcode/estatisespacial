...
Neste bloco único, realizamos o carregamento das bibliotecas, a importação dos dados da pasta **dados/**, a junção das bases e a geração dos mapas das Questões 1 e 2.
...
# Certifique-se de que os arquivos estão na pasta 'dados' no GitHub
...
# Unindo os preços ao shapefile e criando rótulos
glasgow_dados <- left_join(prices_df, glasgow_sf, by = c("IZ" = "IZ")) %>% 
                 st_as_sf()
...
tm_shape(glasgow_dados) + 
  tm_polygons(
    ...
    fill.legend = tm_legend(title = "Preço"),
    id = "rotulo",
    popup.vars = c("Área" = "name", "Preço Mediano" = "preco"),
    lwd = 0.25
  )--- ```
title: "Trabalho Final - Estatística Espacial"
